...
RuleRegistry_1.instance.register(...process_yield_1.default(), ...added_1.default(), ...cost_1.default(), ...requirements_1.default(), ...research_1.default(), ...research_complete_1.default());
